...
$admin_user = 'admin';
$admin_pass = 'password';  // password GUI modificata dallo script toggleGUI()
...
if (!isset($_SESSION['logged'])) {
    ...
    <head>
      ...
      <style>
        :root { --accent-color: <?= htmlspecialchars($accent) ?>; }
        .bg-accent { background-color: var(--accent-color) !important; }
        .btn-accent { background-color: var(--accent-color) !important; border-color: var(--accent-color) !important; color: #fff !important; }
      </style>
    </head>
    <body>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-accent fixed-top">
  <div class="container">
    ...
    <div class="d-flex ms-auto align-items-center">
      ...
      <?php if($debugMode): ?>
        <a class="btn btn-outline-light btn-sm" href="?debug=0">Disable Debug</a>
      <?php endif; ?>
    </div>
  </div>
</nav>
